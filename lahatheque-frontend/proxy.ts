...
/**
 * Next.js Proxy (ex-Middleware) & HTTP Request Logger (SEC-11)
 * Next.js 16 standardise middleware.ts en proxy.ts.
...
export function proxy(request: NextRequest) {
  ...
  // 4. Si connecté et tente d'accéder aux pages d'authentification (/login, /register)
