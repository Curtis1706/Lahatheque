...
import { ArrowLeft, Package, Truck, Eye, BookOpen, Clock, CheckCircle2 } from "lucide-react";
    ...
    },
    {
      ...
      cell: (row) => (
        <span className="text-xs text-foreground-muted font-mono">
          {new Date(row.order_date).toLocaleDateString("fr-FR", { day: "2-digit", month: "short", year: "numeric" })}
        </span>
      ),
    },
    {
  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 w-full space-y-6 max-w-7xl mx-auto animate-in fade-in duration-300">
      ...
      <div className="flex items-center gap-2 text-xs text-foreground-muted">
        ...
        <span>/</span>
        <span className="text-navy font-semibold">Gestion des commandes — À expédier</span>
      </div>
