...
export default function LayoutArtistAudioNewPage() {
  return (
    <div className="space-y-6 max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border pb-6">
        <div className="space-y-1">
          ...
          <h1 className="font-serif font-bold text-2xl sm:text-3xl text-navy flex items-center gap-2.5">
            ...
            Studio Audio — Nouveau Livre Audio
          </h1>
          <p className="text-xs sm:text-sm text-foreground-muted">
            Créez une version audio rattachée à un manuel existant ou déposez un livre audio autonome selon le standard LAHA Éditions.
          </p>
        </div>
      </div>
      ...
      <AudioStudioForm
        role="layout-artist"
        onSuccessRedirectPath="/layout-artist/audio"
      />
    </div>
  );
}
