...
export const ACADEMIC_DISCIPLINES: string[] = [
  ...
  "Arts plastiques",
  "Arts visuels",
  "Assainissement & Génie sanitaire",
  ...
  "Enseignement supérieur & Pédagogie",
  "Entrepreneuriat",
  "Épidémiologie",
  "Ergothérapie",
  "Espagnol",
  ...
  "Métallurgie",
  "Météorologie",
  "Métiers de la culture & Patrimoine",
  "Microbiologie",
  "Mode & Stylisme",
  "Muséologie",
  "Musique & Musicologie",
  ...
  "Photographie",
  "Physiologie",
  "Physique fondamentale & quantique",
  "Pneumologie",
  "Podologie",
  "Portugais",
  "Probabilités & Statistiques",
  "Production animale & Zootechnie",
  "Production végétale & Agronomie",
  ...
  "Rhumatologie",
  "Robotique & Robotique industrielle",
