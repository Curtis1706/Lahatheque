...
const statusConfig: Record<string, { style: string; defaultLabel: string; defaultIcon: React.ElementType }> = {
  ...
  pending_legal_approval: { style: "bg-gold/10 text-gold border-gold/20", defaultLabel: "Attente Juridique", defaultIcon: Clock },
  pending_legal_validation: { style: "bg-gold/10 text-gold border-gold/20", defaultLabel: "Attente Juridique", defaultIcon: Clock },
  pending_layout_validation: { style: "bg-gold/10 text-gold border-gold/20", defaultLabel: "Attente Maquette", defaultIcon: Clock },
