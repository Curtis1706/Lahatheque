...
export function ReadingProgress({
  ...
  words = 0,
  wordsPerMinute = 220,
  label = "Progression de lecture du manuel",
  doneLabel = "Terminé",
  className = "",
  ...
  const readout = `${minutesLeft} min d'étude restantes`;
  ...
  return (
    <div className={cn("flex items-center gap-3", className)}>
      <div
        ...
        className="min-w-0 flex-1 rounded-md bg-background-secondary p-1 border border-border"
      >
        <motion.div
          className="h-1.5 origin-left rounded-sm bg-navy"
          style={{ width: "100%" }}
          initial={false}
      ...
      {estimate ? (
        <div className="grid shrink-0 justify-items-end font-mono text-xs tabular-nums text-foreground-muted">
          <span
            aria-hidden
          ...
          <motion.span
            aria-hidden
            className="col-start-1 row-start-1 whitespace-nowrap text-foreground-muted"
            initial={false}
          ...
          <motion.span
            aria-hidden
            className="col-start-1 row-start-1 flex items-center gap-1 whitespace-nowrap text-navy font-bold"
            initial={false}
