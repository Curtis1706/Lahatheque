        ...
        >
          ...
          <div className="p-4 rounded-2xl bg-background-secondary border border-border space-y-2">
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              <span className="font-mono font-bold text-red-600">{formattedAmount} {debt.currency || "FCFA"}</span>
            </div>
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              <span className="font-semibold text-amber-600">{debt.days_overdue} jours</span>
            </div>
          </div>
              ...
              <div className="space-y-2">
                {REMINDER_LEVELS.map((r) => (
                  <button
                    ...
                    className={`w-full text-left p-3 rounded-xl border transition-all flex items-start gap-3 min-h-[44px] ${
                      level === r.level
