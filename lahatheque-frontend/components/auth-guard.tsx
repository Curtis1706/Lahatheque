...
type AppRole = 'student' | 'teacher' | 'parent' | 'author' | 'admin' | 'super_admin' | 'super_client' | 'wholesaler' | 'publisher' | 'university' | 'legal_reviewer' | 'layout_artist' | 'chief_layout' | 'manager'
