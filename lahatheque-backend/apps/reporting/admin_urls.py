...
from apps.reporting.admin_views import (
    ...
    AdminAuthorRoyaltyDetailView,
    AdminPartnerRoyaltiesView,
    AdminTriggerRoyaltyCalculationView,
...
urlpatterns = [
    ...
    path('finance/partner-royalties/', AdminPartnerRoyaltiesView.as_view(), name='admin-finance-partner-royalties'),
    path('finance/author-royalties/', AdminAuthorRoyaltiesReportView.as_view(), name='admin-finance-author-royalties'),
    path('finance/author-royalties/<uuid:author_id>/', AdminAuthorRoyaltyDetailView.as_view(), name='admin-finance-author-royalty-detail'),
    path('finance/royalties/trigger-now/', AdminTriggerRoyaltyCalculationView.as_view(), name='admin-trigger-royalty-calc'),
    ...
    path('bouquet-offerings/<str:pk>/subscriptions/', AdminBouquetSubscriptionsView.as_view(), name='admin-bouquet-offering-subscriptions'),
