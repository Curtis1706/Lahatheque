...
**Accès** : `admin@lahatheque.com`**Périmètre** : Vue globale de la plateforme, pilotage commercial, gouvernance et sécurité.
...
**Accès** : `maquettiste@lahatheque.com` | **MDP** : `123456`**Périmètre** : Préparation technique et éditoriale des ouvrages avant publication.
...
**Accès** : `chefmaquettiste@lahatheque.com` | **MDP** : `123456`**Périmètre** : Validation finale et contrôle de qualité des dépôts épreuves.
...
**Accès** : `gestionnaire@lahatheque.com` | **MDP** : `123456`**Périmètre** : Logistique, stock physique des livres papier et suivi des livraisons.

- **Gestion des Stocks** : Mouvements de stock papier et alertes de rupture (`/manager/stock`).
- **Suivi des Expeditions** : Commandes à préparer, en transit et livrées (`/manager/delivery`).
...
**Accès** : `juriste@lahatheque.com` | **MDP** : `123456`**Périmètre** : Contrats d'édition, répartition financière des droits et relances légales.
...
**Accès** : `auteur@lahatheque.com` | **MDP** : `123456`**Périmètre** : Suivi commercial autonome des ouvrages publiés et dépôts de manuscrits.

- **Mes Livres Publiés** : Ventes, téléchargements DRM et ventilations par format/pays (`/author/books`).
- **Mes Dépôts Manuscrit (2 Étapes)** : Suivade l'Étape 1 (Étude éditoriale avec suggestion IA) à l'Étape 2 (`/author/submissions`).
...
**Accès** : `editeur@lahatheque.com` | **MDP** : `123456`**Périmètre** : Gestion du catalogue partenaire sur LAHAThèque.

- **Dépôt 3 Modes** : Formulaire web, import en masse ONIX 3.0 et clés API (`/publisher/catalog`).
- **Suivi des Révénus** : Redevances éditeur et tableaux de bord financiers (`/publisher/royalties`).
...
**Accès** : `client@lahatheque.com` | **MDP** : `123456`**Périmètre** : Consommation grand public du catalogue numérique et audio.
...
**Accès** : `grossiste@lahatheque.com` | **MDP** : `123456`**Périmètre** : Achats en grande quantité pour revente.
